FROM debian:jessie
MAINTAINER ShiWenQiang <wenqiang.shi@outlook.com>
...
ADD ./rabbitmq-server_3.6.6-1_all.deb /tmp/rabbit.deb
ADD ./rabbitmq-autocluster_0.6.1.950-1_all.deb /tmp/ac.deb
